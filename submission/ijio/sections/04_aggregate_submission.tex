...
\[
 \DA=\frac{32\gamma d^2(a-c)}{(-6\gamma+d^2+3)(36\gamma^2-20\gamma d^2-36\gamma+d^4+6d^2+9)},
\]
...
\[
 Q_{A,G}(\alpha,2)=-\frac95(25\alpha^2-35\alpha+8)>0,
\]
whereas
\[
...
At
\[
(a,c,\gamma,\lambda,\beta_1,\beta_2)=(100,50,10,0,49/50,0),
\]
...
\[
 x_1^n+x_2^n=\frac{360160}{100239},\qquad x_1^c+x_2^c=\frac{69400}{19119},
\]
and therefore
